...
const ContactCard = () => {
    return (
        <div className="contactCard top-border flex items-center justify-between sm:justify-center p-6 max-w-3xl mx-auto gap-4">
            ...
            <button className="bg-[var(--pa)] hover:bg-[var(--pa-hover)] font-bold h-10 px-4 py-2 rounded-lg shadow-md w-[80%] max-w-300px mt-5 sm:mt-3 transform transition-all duration-200 ease-in-out active:scale-95 hover:scale-105 text-[var(--pt)] cursor-pointer">
                Contact
            </button>
            </div>
        </div>

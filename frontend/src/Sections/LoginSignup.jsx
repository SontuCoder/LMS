...
const LoginSignup = ({ onLogin }) => {
    ...
    return (
        <div className="login-background flex items-center justify-center px-0 py-20 bg-no-repeat bg-cover">
            <div className="login-form-container flex max-w-[90%] border-1 border-[var(--st)]">
                <div className="login-left sm:flex items-center justify-center flex-col hidden sm:visible w-[55%] bg-[rgba(255,255,255,0.2)]">
                    ...
                    <p>You are Few Minutes Way To Boost Your Skills With <span className="">GenZTechno</span></p>
                </div>
                ...
                <div className="login-right w-full sm:w-[50%]">
                    {loginPage ? (
                        ...
                        <div className="max-w-sm mx-auto p-6  h-full">
                            <h2 className=" relative text-3xl font-bold text-center mb-10"><span className='absolute left-0 top-1 cursor-pointer'  onClick={()=>navigate('/')}><i className='bx bx-left-arrow-alt' ></i></span>Login</h2>
                    ...
                    <div className="max-w-sm mx-auto p-6 h-full">
                        ...
                        <p className="">Otp has been sended on your gmail.</p>
                        <p className=""><span className=''><i className='bx bx-left-arrow-alt' ></i></span> Go Back on Sign Up page.</p>
                    </div> 
